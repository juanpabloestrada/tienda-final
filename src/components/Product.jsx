...
const Product = () => {
    ...
    const [details,steDetails]= useState({});
        let [baseQty, setBaseQty]= useState(1);
    const location = useLocation ()
    useEffect(() => {
        steDetails(location.state.item);
    },[])
    return (
        <div>
            <div className="max-w-screen-xl mx-auto my-10 flex gap-10">
                ...
                <div className="w-3/5 flex flex-col justify-center gap-12">
                    ...
                    <div className="flex items-cemter gap-2 text-base">
                        <div className="flex">
                            <MdOutlineStar />
                            <MdOutlineStar />
                            <MdOutlineStar />
                    ...
                    <p className="text-base text-gray-500 -m-3">{details.description}</p>
